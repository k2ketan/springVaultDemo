...
public class TransitConverter implements AttributeConverter<String, String> {
	...
	public String convertToDatabaseColumn(String customer) {	
		...
		String cipherText = vaultOps.opsForTransit().encrypt("creditCards", plaintext).getCiphertext();
		return cipherText;
	}
	...
	public String convertToEntityAttribute(String customer) {
        ...
        String plaintext = vaultOps.opsForTransit().decrypt("creditCards", ciphertext).asString();
		return plaintext;
	}
